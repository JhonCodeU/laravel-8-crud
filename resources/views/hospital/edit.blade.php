        ...
        <div class="col">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select id="entity" name="entity" class="form-control">
                              ...
                              <option value="publica" {{(old('entity', $hospital->entity) == ('publica')) ? 'selected': '' }}>Publica</option>
                              <option value="privada" {{(old('entity', $hospital->entity) == ('privada')) ? 'selected': '' }}>Privada</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group form-check">
                  ...
                  {{old('active', $hospital->is_active) ? 'checked' : ''}}>
